...
import { formatDateString, getPreferredPathForDisplay, makeMapKey } from '@/utils';
...
export default function TicketRow({ticket}: { ticket: Ticket }) {
    ...
    const ticketFsp = zonesAndFileSharePathsMap[makeMapKey('fsp', ticket.fsp_name)] as FileSharePath;
    const displayPath = getPreferredPathForDisplay(pathPreference, ticketFsp, ticket.path)
